...
<aside id="default-sidebar"
       class="fixed top-0 left-0 z-40 w-64 h-screen  transition-transform -translate-x-full sm:translate-x-0 motion-preset-blur-right motion-duration-1500"
       aria-label="Sidebar">
    <div
        class="h-full px-4 py-6 overflow-y-auto bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li class="menu-item">
                <button
                    ...
                    <svg class="w-3 h-3 menu-arrow" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                         viewBox="0 0 10 6">
                ...
                <ul class="submenu py-2 space-y-2">
                    <li>
                        <a href="{{route('admin.register_member')}}"
                           class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Register
                            Member & All Registered Members</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                <a href="{{route('admin.events')}}"
                   class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="ms-3">Upcoming events</span>
                </a>
            </li>
                ...
                <ul class="submenu py-2 space-y-2">
                    <li>
                        <a href="{{route('admin.family_gathering')}}"
                           class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Register
                            Member & Registered Members</a>
                    </li>
                    <li>
                        <a href="{{route('admin.record_management')}}"
                           class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Record
                            Management</a>
                    </li>
                    <li>
                        <a href="{{route('admin.familyGatheringAllYears')}}"
                           class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Family
                            Gathering registration </a>
                    </li>
                </ul>
            </li>
                ...
                <ul class="submenu py-2 space-y-2">
                    ...
                    <li>
                        <a href="{{route('admin.online')}}"
                           class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Online
                            Transaction</a>
                    </li>
                </ul>
            </li>
