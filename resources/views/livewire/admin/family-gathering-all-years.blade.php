<div class="p-10 sm:ml-64 min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-gray-100 motion-preset-expand motion-duration-2000">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        ...
        <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-green-500">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600">Registed Males</p>
                    <p class="text-2xl font-bold text-gray-800">{{ $number_of_registered_males }}</p>
                </div>
                <svg class="w-10 h-10 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <circle cx="9" cy="14" r="5" stroke-width="2"/>
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5h5m0 0v5m0-5l-6 6"/>
            </svg>
            </div>
        </div>
          <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-green-500">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600">Registed Females</p>
                    <p class="text-2xl font-bold text-gray-800">{{ $number_of_registered_females }}</p>
                </div>
                <svg class="w-10 h-10 text-pink-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <circle cx="12" cy="9" r="5" stroke-width="2"/>
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14v6m-3 0h6"/>
</svg>
            </div>
        </div>
