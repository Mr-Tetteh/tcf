                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="relative">
                                            ...
                                            >
                                                ...
                                                <p class="text-sm text-gray-600">Click or drag study material to upload</p>
                                                <p class="text-xs text-gray-500 mt-1">doc, pdf</p>
                                            </label>
                                        </div>
                                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-6">
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full">
                                ...
                                <tr>
                                    <th class="px-6 py-4 text-left text-sm font-semibold text-gray-600">Material Name </th>
                                    <th class="px-6 py-4 text-left text-sm font-semibold text-gray-600">Study Material</th>
