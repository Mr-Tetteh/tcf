    ...
    <section class="py-5">
        <div class="container mx-auto px-4">
            <div class="mb-16 text-center">
                <h2 class="text-4xl font-bold text-gray-900 mb-4">Latest Materials</h2>
                <p class="text-lg text-gray-600">Read blessed by our collection of inspiring messages</p>
            </div>
                            ...
                            <div class="lg:w-3/5 p-8">
                                ...
                                <div class="bg-gray-50 rounded-xl p-4">
                                    <div class="flex items-center gap-4">
                                            ...
                                            <a href="{{Storage::url($data->study_material) }}"  class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200">
